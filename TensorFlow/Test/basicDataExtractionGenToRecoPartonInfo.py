...
flavorDataH5 = f.create_earray(f.root, 'flavor', i32Atom, (0, 1))


genDataH5 = f.create_earray(f.root, 'genData', f32Atom, (0, 4))
recoDataH5 = f.create_earray(f.root, 'recoData', f32Atom, (0, 4))
partonDataH5 = f.create_earray(f.root, 'partonData', f32Atom, (0, 4))

print(flavors.shape)
print(genData.shape)
flavorDataH5.append(flavors)

genDataH5.append(genData)
recoDataH5.append(recoData)
partonDataH5.append(partonData)
